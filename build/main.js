...
function towards(current, target, max_delta) {
...
var Emotion;
(function (Emotion) {
    Emotion[Emotion["HAPPY"] = 0] = "HAPPY";
    Emotion[Emotion["SAD"] = 1] = "SAD";
    Emotion[Emotion["MEH"] = 2] = "MEH";
})(Emotion || (Emotion = {}));
;
var Interest;
(function (Interest) {
    Interest[Interest["SQUARE"] = 0] = "SQUARE";
    Interest[Interest["CIRCLE"] = 1] = "CIRCLE";
    Interest[Interest["TRIANGLE"] = 2] = "TRIANGLE";
    Interest[Interest["DIAMOND"] = 3] = "DIAMOND";
    Interest[Interest["HEX"] = 4] = "HEX";
})(Interest || (Interest = {}));
;
...
class Person {
    ...
    hear_topic(other, relation, topic) {
    ...
    draw() {
        ...
        if (this.collides(mouseX, mouseY) || selected_person == this)
            scale(1.1, 1.1);
        // Shadow
        push();
        translate(10, 10);
